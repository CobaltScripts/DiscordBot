...
export default class RoleCommand extends Command {
    ...
    async execute(_, context) {
        ...
        const user = guild.members.cache.get(context.args.user) ?? await guild.members.fetch(context.args.user).catch(() => null);
        ...
        const role = guild.roles.cache.get(context.args.role);
        if (!role) {
            return await context.reply({
